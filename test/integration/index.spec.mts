...
void describe('SonarQube Reporter', () => {
    void it('will generate a report entry on failure', async () => {
        ...
        const expected: (string | RegExp)[] = [
            ...
            /^\t\t<testCase name="Sample test suite » will generate a report entry on failure" duration="\d+"><failure message="Error: Expected 2 to equal 1/u,
            '',
            '2 !== 1',
            '"/></testCase>',
            /^\t\t<testCase name="Sample test suite » will not generate anything" duration="\d+"\/>/u,
            /^\t\t<testCase name="Sample test suite » Nested test suite » will be skipped" duration="\d+"><skipped message="[^"]+"\/><\/testCase>/u,
            /^\t\t<testCase name="Sample test suite » Nested test suite » todo test" duration="\d+"><skipped message="[^"]+"\/><\/testCase>/u,
